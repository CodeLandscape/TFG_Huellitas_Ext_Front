...
export class AuthTokenService {
  ...
  // apiFacturacionBaseUrl = environment.api.facturacionUrl;
  ...
  constructor(private ht: HttpClient, public cookieService: CookieService) {
    if (this.cookieService.check('SSOPREVJWT')) {
      this.apiToken = this.cookieService.get('SSOPREVJWT');
    }
  }
  ...
  /* getApiFacturacionBaseUrl() {
    return this.apiFacturacionBaseUrl;
  } */
